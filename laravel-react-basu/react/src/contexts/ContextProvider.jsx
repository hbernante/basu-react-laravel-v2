...
const tmpReservations = [
  {
    ...
    status: true,
    description: "taenamo taenamo taenamo.<br>taenamo taenamo taenamo",
  ...
  },
  {
    ...
    slug: "Shuttle Bus",
    status: true,
    description: "nagpapagawa pbl sa christmas break amp",
  ...
  },
  {
    ...
    slug: "Shuttle Bus",
    status: true,
    description: "Hatdog cheesdog tatay mo sabog",
